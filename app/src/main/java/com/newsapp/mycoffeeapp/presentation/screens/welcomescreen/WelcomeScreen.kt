package com.newsapp.mycoffeeapp.presentation.screens.welcomescreen
...
fun WelcomeScreen(navController: NavController) {
    Box(
        ...
        Image(
            painter = painterResource(R.drawable.coffee_splash),
        ...
        Column(
            ...
            Text(
                text = "Fall in love with coffe in Blissfull quality delight",
                color = Color.White,
